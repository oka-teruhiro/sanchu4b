...
class Update2 extends StatefulWidget {
  const Update2({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          const ListTile(
            title: Text(
              '　1900.1.1の日支は、「戌」です。子・丑・寅・卯・辰・巳・午・'
          ...
          const ListTile(
            title: Text(
              '　日干の一文字と日支の一文字をつなぐと日柱の60干支になります。'
          ...
          const ListTile(
            title: Text(
              '　60日で60干支が繰り返されるように、60ヶ月で60干支が繰り返され、'
              '60年で60干支が繰り返されます。',
              style: TextStyle(
                height: 1.5,
              ),
          ...
          const ListTile(
            title: Text(
              '　したがって、日柱の60干支に対応する年が60年に一度存在します。'
          ...
          const ListTile(
            title: Text(
              '干合とは、甲⇔己、丙⇔辛、戊⇔癸、庚⇔乙、壬⇔丁の組み合わせ、'
