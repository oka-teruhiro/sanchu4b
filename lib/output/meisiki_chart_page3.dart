...
class MeisikiChartPage3 extends StatefulWidget {
  final int seinenInt;
  ...
  @override
  State<MeisikiChartPage3> createState() => _MeisikiChartPage3State();
}

class _MeisikiChartPage3State extends State<MeisikiChartPage3> {
  int counter = 0;
  int counterY = 0;
  int counterM = 0;
  int counterD = 0;
