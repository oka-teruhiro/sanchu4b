...
class MeisikiChartPage5 extends StatefulWidget {
  final int seinenInt;
  ...
  @override
  State<MeisikiChartPage5> createState() => _MeisikiChartPage5State();
}

class _MeisikiChartPage5State extends State<MeisikiChartPage5> {
  int counter = 0;
  int counterY = 0;
  int counterM = 0;
  int counterD = 0;
