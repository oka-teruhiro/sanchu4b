      ...
      body: SizedBox(
        ...
        child: ListView(
          children: <Widget>[
            ...
            const ListTile(
              title: Text(
                '　病とか死は非常に取越し苦労が多いです。病気になちゃったわけで、死に比べると治る可能性がある、ちょっと希望があるという状態。先の先を読むところがあります。',
              ),
            ),
            const ListTile(
              title: Text(
                  '　子供にこの病が入っているからダメではなく、例えばそろばんとかさせると細かく計算してそういう部門でのばしてあげるといいです。確かに計算に強い。'),
            ),
            const ListTile(
              title: Text(
                  '　実際に病院の医師を調べてみると、六割が病とか死です。医者なので運勢強いのかなというとそうではなくて、やはり病とか死を持っています。もしお子さんに病とか死とか入っていたら、病院関係とか研究者とか博士とかまた易者も非常にいいです。'),
            ),
            const ListTile(
              title: Text('　いろんな方面からチェックできる能力を持っています。心とか体を治すドクターには非常にいいです。'),
            ),
            ListTile(
